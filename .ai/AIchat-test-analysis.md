 ...
 */
export function extractCurrentMealPlan(
...
**Next Steps:**
4. Extract and test error message logic
5. Extract and test state bridge creation
6. Consider extracting `MessageItem` for component tests
