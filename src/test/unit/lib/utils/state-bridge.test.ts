...
describe("createStateBridge", () => {
  ...
  describe("session ID handling", () => {
    it("should preserve session ID exactly as provided", () => {
      const messageHistory: ChatMessage[] = [{ role: "assistant", content: "Message content" }];
  ...
  describe("message content handling", () => {
    it("should preserve full assistant message content", () => {
      ...
      const messageHistory: ChatMessage[] = [{ role: "assistant", content: longContent }];
    ...
    it("should handle multiline message content", () => {
      ...
      const messageHistory: ChatMessage[] = [{ role: "assistant", content: multilineContent }];
    ...
    it("should handle special characters in message content", () => {
      ...
      const messageHistory: ChatMessage[] = [{ role: "assistant", content: specialContent }];
